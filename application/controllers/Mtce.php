...
class Mtce extends Application {
	...
	private function showit()
	{
		...
		$fields = array(
            ...
            'fsize'     => makeComboBox('Size',     'size',     $task->size,     $sizeparms,  "How large is this task?"),
            'fgroup'    => makeComboBox('Group',    'group',    $task->group,    $groupparms, "What group this task belongs to?"),
            'fstatus'   => makeComboBox('Status',   'status',   $task->status,   $statparms,  "What is the status of this task?"),
